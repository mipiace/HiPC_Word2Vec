...
void InitNet() {
  ...
  unsigned long long random_seed = 25214903917;
  // unsigned long long random_seed = 43854821829;
  // unsigned long long random_seed = 72847103851;
  // unsigned long long random_seed = 35895678923;
  // unsigned long long random_seed = 50914586385;
...
#pragma omp parallel for num_threads(num_threads) schedule(static, 1)
  ...
  for (int i = 0; i < vocab_size * hidden_size; i++) {
    next_random = next_random * random_seed + 11;
