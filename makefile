...
accSGNS_gpu_text8: word2vec_gpu_text8.cu
	$(NVCC) $(CUDA_FLAGS) $(CUDA_INC) -o accSGNS_gpu_text8 word2vec_gpu_text8.cu $(CUDA_LIB)
accSGNS_gpu_1b: word2vec_gpu_1b.cu
	$(NVCC) $(CUDA_FLAGS) $(CUDA_INC) -o accSGNS_gpu_1b word2vec_gpu_1b.cu $(CUDA_LIB)
accSGNS_gpu_blogcatalog: word2vec_gpu_blogcatalog.cu
	$(NVCC) $(CUDA_FLAGS) $(CUDA_INC) -o accSGNS_gpu_blogcatalog word2vec_gpu_blogcatalog.cu $(CUDA_LIB)
accSGNS_gpu_ppi: word2vec_gpu_ppi.cu
	$(NVCC) $(CUDA_FLAGS) $(CUDA_INC) -o accSGNS_gpu_ppi word2vec_gpu_ppi.cu $(CUDA_LIB)
accSGNS_gpu_wikipedia: word2vec_gpu_wikipedia.cu
	$(NVCC) $(CUDA_FLAGS) $(CUDA_INC) -o accSGNS_gpu_wikipedia word2vec_gpu_wikipedia.cu $(CUDA_LIB)
accSGNS_gpu_facebook: word2vec_gpu_facebook.cu
	$(NVCC) $(CUDA_FLAGS) $(CUDA_INC) -o accSGNS_gpu_facebook word2vec_gpu_facebook.cu $(CUDA_LIB)
accSGNS_gpu_astroph: word2vec_gpu_astroph.cu
	$(NVCC) $(CUDA_FLAGS) $(CUDA_INC) -o accSGNS_gpu_astroph word2vec_gpu_astroph.cu $(CUDA_LIB)
